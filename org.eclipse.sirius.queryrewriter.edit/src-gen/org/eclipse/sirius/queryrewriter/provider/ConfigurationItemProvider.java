...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.queryrewriter.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_paths_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_paths_feature", "_UI_Configuration_type"),
				 QueryrewriterPackage.Literals.CONFIGURATION__PATHS,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Accessible Groups feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAccessibleGroupsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_accessibleGroups_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_accessibleGroups_feature", "_UI_Configuration_type"),
				 QueryrewriterPackage.Literals.CONFIGURATION__ACCESSIBLE_GROUPS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Languages To Rewrite feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLanguagesToRewritePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_languagesToRewrite_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_languagesToRewrite_feature", "_UI_Configuration_type"),
				 QueryrewriterPackage.Literals.CONFIGURATION__LANGUAGES_TO_REWRITE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Auto Fill feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAutoFillPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_autoFill_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_autoFill_feature", "_UI_Configuration_type"),
				 QueryrewriterPackage.Literals.CONFIGURATION__AUTO_FILL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Configuration)object).getAutoFill();
