...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Name Rewrite</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.queryrewriter.impl.NameRewriteImpl#getOld <em>Old</em>}</li>
 *   <li>{@link org.eclipse.sirius.queryrewriter.impl.NameRewriteImpl#getNew <em>New</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NameRewriteImpl extends MinimalEObjectImpl.Container implements NameRewrite {
	/**
	...
	protected EClass eStaticClass() {
		return QueryrewriterPackage.Literals.NAME_REWRITE;
	}
	...
	public void setOld(String newOld) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryrewriterPackage.NAME_REWRITE__OLD, oldOld, old));
	}
	...
	public void setNew(String newNew) {
		...
		new_ = newNew;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryrewriterPackage.NAME_REWRITE__NEW, oldNew, new_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryrewriterPackage.NAME_REWRITE__OLD:
				return getOld();
			case QueryrewriterPackage.NAME_REWRITE__NEW:
				return getNew();
		}
